...
mutable struct Simulation
    ...
    function Simulation(m::jlModel, d::jlData, name::String;
                        width=0, height=0)
...
##################################################### functions
function alignscale(s::Simulation)
...
function start(mm::jlModel, dd::jlData, width=1200, height=900) # TODO named args for callbacks
    ...
    s = Simulation(mm, dd, "Simulate"; width=width, height=height)
...
function render(s::Sim.Simulation, w::GLFW.Window)
   wi, hi = GLFW.GetFramebufferSize(w)
